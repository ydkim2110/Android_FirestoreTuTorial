...
public class MainActivity extends AppCompatActivity implements
    ...
    public void createNewNote(String title, String content) {
        ...
        DocumentReference newNoteRef = db.collection("notes").document();
    ...
    public void updateNote(final Note note) {
        ...
        DocumentReference noteRef = db.collection("notes").document(note.getNote_id());
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.fab: {
                ...
                dialog.show(getSupportFragmentManager(), "New Note Dialog");
                break;
            }
        }
        ...
        notesQuery.get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    makeSnackBarMessage("Query Failed. Check log");
                }
            }
        });
